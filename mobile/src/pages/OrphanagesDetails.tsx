...
export default function OrphanageDetails() {
  ...
  const params = router.params as IOrphanageDetails;
  ...
  function handleOpenGoogleMapsRouters() {
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <TouchableOpacity onPress={handleOpenGoogleMapsRouters} style={styles.routesContainer}>
            <Text style={styles.routesText}>Ver rotas no Google Maps {orphanage.opening_hours}</Text>
          </TouchableOpacity>
        </View>
